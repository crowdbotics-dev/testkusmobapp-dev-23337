...
## Project Structure
    ...
    ├── testkusmobapp_dev_23337  # Django project configurations
...
1. Clone this repo and `cd testkusmobapp_dev_23337`
...
2. Clone this repo and `cd testkusmobapp_dev_23337`
